...
public class CancelAllRequestSample {

    PutObjectRequest putObjectRequest;
    QServiceCfg qServiceCfg;

    public CancelAllRequestSample(QServiceCfg qServiceCfg){
...
//        putObjectRequest.setXCOSContentSha1(SHA1Utils.getSHA1FromPath(Environment.getExternalStorageDirectory().getPath() + "/1.mp4"));
        ...
        putObjectRequest.setSourceSerializer(new BasicSignatureSourceSerializer(5000));
        try {
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    qServiceCfg.cosXmlService.cancelAll();
                }
            }).start();
